 ...
 * @author luis
 */
public class AsteriskCallEventsStateProd1 extends Thread implements OriginateCallback, ManagerEventListener {
...
//    private final Logger logger = LoggerFactory.getLogger(AsteriskCallEventsState.class);
    ...
    public AsteriskCallEventsStateProd1() {
...
String[] resp;
        try {
            ...
            java.util.logging.Logger.getLogger(AsteriskCallEventsStateProd1.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String[] args) throws Exception {
        ...
        AsteriskCallEventsStateProd1 call = new AsteriskCallEventsStateProd1();
        call.setNumber("102"); //destino
        call.setMessage("103");//origen
        call.start();
//        System.out.println(resp);
    }
}
