 ...
 * @author luis
 */
public class AsteriskCallEventsStateProdAl implements OriginateCallback, ManagerEventListener {
...
//    private final Logger logger = LoggerFactory.getLogger(AsteriskCallEventsState.class);
    ...
    private String[] respuesta = {"0", "0", "0"};//estado, tiempo hablado, tiempo timbrado.
    private String destinationUniqueIdCallChannel1;
    private Long inicioConversacion;
    private Long finConversacion;

    public AsteriskCallEventsStateProdAl() {
...
//        originateAction.setVariable("customernum", phoneNumber);
        ...
        originateAction.setData("googletts.agi,\"" + phoneNumber + "\",es");
        originateAction.setCallerId("Clave2000");        
    ...
    public String[] originate() throws IOException, AuthenticationFailedException,
...
//        Thread.sleep(100000);
    ...
    public void onSuccess(AsteriskChannel channel) {
        this.sourceUniqueIdCall = channel.getName();
        this.destinationUniqueIdCallChannel1= channel.getId();
...
//            double timestamp = e.getTimestamp();
            ...
            if (e.isUnlink()) {
                ...
                if (this.sourceUniqueIdCall.equals(channel2.substring( 0, channel2.length( ) - 8 ))) {
//                    this.sourceUniqueIdCall = e.getUniqueId1();
//                    this.destinationUniqueIdCall = e.getUniqueId2();
                    this.sourceUniqueIdCallChannel = e.getChannel1();
                    this.destinationUniqueIdCallChannel = channel2.substring( 0, channel2.length( ) - 8 );
//                    this.inicioConversacion=event.getDateReceived().getTime();
...
//                    this.outEvent = true;
            ...
            if (e.isLink()) {
                System.out.println("ligada: " + e.getCallerId1() + " Destino: " + e.getCallerId2());
                                    this.inicioConversacion=event.getDateReceived().getTime();
//                    this.sourceUniqueIdCallChannel = channel2.substring( 0, channel2.length( ) - 8 );
                                    this.sourceUniqueIdCallChannel=e.getChannel1();
            ...
            System.out.println("Tiempo inicio evento BridgeEvent: " + tiempoInicioEvento + "\n"
                    ...
                    + "channel1: " + channel1 + "\n"
                    + "channel2: " + channel2 + "\n"
                    + "channel2:sin zombie " +channel2.substring( 0, channel2.length( ) - 8 )+ "\n"
                    + "uniqueId1: " + uniqueId1 + "\n"
                    + "uniqueId2: " + uniqueId2 + "\n"
                    + "Todos los datos de la llmada: " + todoevent + "\n" + "\n");
        ...
        //        } 
            ...
            System.out.println("Tiempo inicio evento HangupEvent: " + tiempoInicioEvento + "\n"
                    ...
                    + "Id unico source: " + uniqueId + "\n"
                    + "Todos los datos de la llmada: " + todoevent + "\n" + "\n");
if (uniqueId.equals(this.destinationUniqueIdCallChannel1)) {
            this.outEvent = true;
            this.finConversacion=event.getDateReceived().getTime();
           Long duracionConversacion = (this.finConversacion-this.inicioConversacion)/1000;
           this.respuesta[1]=duracionConversacion.toString();
...
//        }
        if (event instanceof CdrEvent) {
            ...
            System.out.println(this.sourceUniqueIdCallChannel);
System.out.println("getChannel sourceUniqueIdCallChannel: "+this.sourceUniqueIdCallChannel);
            if (this.sourceUniqueIdCallChannel.equals(cdr.getChannel())) {
...
//                
                this.respuesta[0] = "1";
                this.respuesta[1] = cdr.getBillableSeconds().toString(); // add at 2rd index
                this.respuesta[2] = tiempotimbrado.toString(); // add at 2rd index
...
//this.outEvent = true;
    ...
    public static void main(String[] args) throws Exception {
        ...
        call.setNumber("10"); //destino
        call.setMessage("hola asterisk esta es una prueba para probar la funcionalidad de una llmada con conversion de texto a voz, muchas gracias por su colaboración");//origen
        String[] resp = call.originate();
        System.out.println(resp);
    }
}
